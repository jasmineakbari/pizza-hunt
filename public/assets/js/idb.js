...
let db;
// establish a connection to IndexedDB database called 'pizza_hunt' and set 
// it to version 1
...
request.onupgradeneeded = function(event) {
    ...
    // create an object store (table) called `new_pizza`, set it 
    // to have an auto incrementing primary key of sorts 
...
// This function will be executed if we attempt to submit a new pizza and 
